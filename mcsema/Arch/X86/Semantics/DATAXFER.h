...
DEF_SEM(XCHG, D1 dst, S1 dst_val, D2 src, S2 src_val) {
  auto old_dst = R(dst_val);
  auto old_src = R(src_val);
  W(dst) = old_src;
  W(src) = old_dst;
}
...
DEF_ISEL(MOVDQA_XMMdq_MEMdq) = MOV<MV128W, V128>;
...
872 MOVLPS MOVLPS_XMMq_MEMq DATAXFER SSE SSE ATTRIBUTES: UNALIGNED
873 MOVLPS MOVLPS_MEMq_XMMps DATAXFER SSE SSE ATTRIBUTES: UNALIGNED
...
1149 MOVQ MOVQ_XMMdq_MEMq_0F6E DATAXFER SSE2 SSE2 ATTRIBUTES: UNALIGNED
1150 MOVQ MOVQ_XMMdq_GPR64 DATAXFER SSE2 SSE2 ATTRIBUTES: UNALIGNED
1151 MOVQ MOVQ_MEMq_XMMq_0F7E DATAXFER SSE2 SSE2 ATTRIBUTES: UNALIGNED
1152 MOVQ MOVQ_GPR64_XMMq DATAXFER SSE2 SSE2 ATTRIBUTES: UNALIGNED
1153 MOVQ MOVQ_MEMq_XMMq_0FD6 DATAXFER SSE2 SSE2 ATTRIBUTES: UNALIGNED
1154 MOVQ MOVQ_XMMdq_XMMq_0FD6 DATAXFER SSE2 SSE2 ATTRIBUTES: UNALIGNED
1155 MOVQ MOVQ_XMMdq_MEMq_0F7E DATAXFER SSE2 SSE2 ATTRIBUTES: UNALIGNED
1156 MOVQ MOVQ_XMMdq_XMMq_0F7E DATAXFER SSE2 SSE2 ATTRIBUTES: UNALIGNED
...
1439 MOVD MOVD_XMMdq_MEMd DATAXFER SSE2 SSE2 ATTRIBUTES: UNALIGNED
1440 MOVD MOVD_XMMdq_GPR32 DATAXFER SSE2 SSE2 ATTRIBUTES: UNALIGNED
1441 MOVD MOVD_XMMdq_MEMd DATAXFER SSE2 SSE2 ATTRIBUTES: UNALIGNED
1442 MOVD MOVD_XMMdq_GPR32 DATAXFER SSE2 SSE2 ATTRIBUTES: UNALIGNED
1443 MOVD MOVD_MEMd_XMMd DATAXFER SSE2 SSE2 ATTRIBUTES: UNALIGNED
1444 MOVD MOVD_GPR32_XMMd DATAXFER SSE2 SSE2 ATTRIBUTES: UNALIGNED
1445 MOVD MOVD_MEMd_XMMd DATAXFER SSE2 SSE2 ATTRIBUTES: UNALIGNED
1446 MOVD MOVD_GPR32_XMMd DATAXFER SSE2 SSE2 ATTRIBUTES: UNALIGNED
...
2133 VMOVQ VMOVQ_XMMdq_MEMq_6E DATAXFER AVX AVX ATTRIBUTES:
2134 VMOVQ VMOVQ_XMMdq_GPR64q DATAXFER AVX AVX ATTRIBUTES:
2135 VMOVQ VMOVQ_MEMq_XMMq_7E DATAXFER AVX AVX ATTRIBUTES:
2136 VMOVQ VMOVQ_GPR64q_XMMq DATAXFER AVX AVX ATTRIBUTES:
2137 VMOVQ VMOVQ_XMMdq_MEMq_7E DATAXFER AVX AVX ATTRIBUTES:
2138 VMOVQ VMOVQ_XMMdq_XMMq_7E DATAXFER AVX AVX ATTRIBUTES:
2139 VMOVQ VMOVQ_MEMq_XMMq_D6 DATAXFER AVX AVX ATTRIBUTES:
2140 VMOVQ VMOVQ_XMMdq_XMMq_D6 DATAXFER AVX AVX ATTRIBUTES:
2141 VMOVD VMOVD_XMMdq_MEMd DATAXFER AVX AVX ATTRIBUTES:
2142 VMOVD VMOVD_XMMdq_GPR32d DATAXFER AVX AVX ATTRIBUTES:
2143 VMOVD VMOVD_MEMd_XMMd DATAXFER AVX AVX ATTRIBUTES:
2144 VMOVD VMOVD_GPR32d_XMMd DATAXFER AVX AVX ATTRIBUTES:
2145 VMOVD VMOVD_XMMdq_MEMd DATAXFER AVX AVX ATTRIBUTES:
2146 VMOVD VMOVD_XMMdq_GPR32d DATAXFER AVX AVX ATTRIBUTES:
2147 VMOVD VMOVD_MEMd_XMMd DATAXFER AVX AVX ATTRIBUTES:
2148 VMOVD VMOVD_GPR32d_XMMd DATAXFER AVX AVX ATTRIBUTES:
...
2620 VMOVLPS VMOVLPS_XMMdq_XMMdq_MEMq DATAXFER AVX AVX ATTRIBUTES:
2621 VMOVLPS VMOVLPS_MEMq_XMMq DATAXFER AVX AVX ATTRIBUTES:
...
3740 VMOVQ VMOVQ_XMMu64_GPR64u64_AVX512 DATAXFER AVX512EVEX AVX512F_128N ATTRIBUTES:
