...
template <typename D1, typename S1>
DEF_SEM(LEGACY_MOVQ, D1 dst, S1 src_vec) {
...
DEF_ISEL(VMOVQ_XMMu64_MEMu64_AVX512) = MOV<VV128W, M64>;
IF_64BIT(DEF_ISEL(VMOVQ_GPR64u64_XMMu64_AVX512) = MOVQ<R64W, V128>;)
IF_64BIT(DEF_ISEL(VMOVQ_XMMu64_GPR64u64_AVX512) = MOV<VV128W, R64>;)
DEF_ISEL(VMOVQ_XMMu64_XMMu64_AVX512) = MOVQ<VV128W, V128>;
DEF_ISEL(VMOVQ_MEMu64_XMMu64_AVX512) = MOVQ<M64W, V128>;
#endif  // HAS_FEATURE_AVX512
#endif  // HAS_FEATURE_AVX

// Note: Use `MOV` with `vec <- r/m64`, but `MOVQ` for `r/m64 <- vec` and
//       `vec <- vec` so that the low qword of the source operand is extracted,
//       resulting in zero assignment to the high qword of the XMM register.
...
DEF_ISEL(VMOVD_MEMu32_XMMu32_AVX512) = MOVD<M32W, V128>;
DEF_ISEL(VMOVD_GPR32u32_XMMu32_AVX512) = MOVD<R32W, V128>;
#endif  // HAS_FEATURE_AVX512
#endif  // HAS_FEATURE_AVX
...
DEF_ISEL(MOVSD_XMM_XMMdq_MEMsd) = MOVQ<V128W, MV64>;
DEF_ISEL(MOVSD_XMM_XMMsd_XMMsd_0F10) = LEGACY_MOVQ<V128W, V128>;
DEF_ISEL(MOVSD_XMM_MEMsd_XMMsd) = MOVQ<M64W, V128>;
DEF_ISEL(MOVSD_XMM_XMMsd_XMMsd_0F11) = LEGACY_MOVQ<V128W, V128>;
#if HAS_FEATURE_AVX
DEF_ISEL(VMOVSD_XMMdq_MEMq) = MOVQ<VV128W, MV64>;
DEF_ISEL(VMOVSD_MEMq_XMMq) = MOVQ<M64W, V128>;
DEF_ISEL(VMOVSD_XMMdq_XMMdq_XMMq_10) = VMOVQ_XMM_XMM_SRC2<V128>;
DEF_ISEL(VMOVSD_XMMdq_XMMdq_XMMq_11) = VMOVQ_XMM_XMM_SRC2<V128>;
#endif  // HAS_FEATURE_AVX
/*
2103 VMOVSD  DATAXFER AVX AVX ATTRIBUTES: SIMD_SCALAR
2104 VMOVSD  DATAXFER AVX AVX ATTRIBUTES: SIMD_SCALAR
2105 VMOVSD  DATAXFER AVX AVX ATTRIBUTES: SIMD_SCALAR
2106 VMOVSD  DATAXFER AVX AVX ATTRIBUTES: SIMD_SCALAR
