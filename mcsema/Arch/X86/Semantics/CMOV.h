...
#ifndef MCSEMA_ARCH_X86_SEMANTICS_CMOV_H_
#define MCSEMA_ARCH_X86_SEMANTICS_CMOV_H_
...
DEF_ISEL(FCMOVNU_ST0_X87_80) = CMOVNP<F80W, F80>;
DEF_ISEL(FCMOVNB_ST0_X87_80) = CMOVNB<F80W, F80>;
DEF_ISEL(FCMOVNE_ST0_X87_80) = CMOVNZ<F80W, F80>;
DEF_ISEL(FCMOVBE_ST0_X87_80) = CMOVBE<F80W, F80>;
DEF_ISEL(FCMOVNBE_ST0_X87_80) = CMOVNBE<F80W, F80>;
DEF_ISEL(FCMOVU_ST0_X87_80) = CMOVP<F80W, F80>;
DEF_ISEL(FCMOVE_ST0_X87_80) = CMOVZ<F80W, F80>;
DEF_ISEL(FCMOVB_ST0_X87_80) = CMOVB<F80W, F80>;

#endif  // MCSEMA_ARCH_X86_SEMANTICS_CMOV_H_
