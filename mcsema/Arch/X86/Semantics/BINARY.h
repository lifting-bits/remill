...
IF_AVX(DEF_ISEL(VMULSS_XMMdq_XMMdq_MEMdq) = MULSS<VV128W, VV128, MV128>;)
IF_AVX(DEF_ISEL(VMULSS_XMMdq_XMMdq_XMMdq) = MULSS<VV128W, VV128, VV128>;)

DEF_ISEL(MULSD_XMMsd_MEMsd) = MULSD<V128W, V128, MV128>;
DEF_ISEL(MULSD_XMMsd_XMMsd) = MULSD<V128W, V128, V128>;
IF_AVX(DEF_ISEL(VMULSD_XMMdq_XMMdq_MEMdq) = MULSD<VV128W, VV128, MV128>;)
IF_AVX(DEF_ISEL(VMULSD_XMMdq_XMMdq_XMMdq) = MULSD<VV128W, VV128, VV128>;)
