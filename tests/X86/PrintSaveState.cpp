...
// `mcsema/Arch/X86/Runtime/State.h` in `__mcsema_basic_block` and then
...
int main(void) {
  ...
  // `PUSHFQ`.
  printf("popfq\n");
  printf("push QWORD PTR [SYMBOL(gStackSaveSlot)]\n");
  printf("lea RSP, [RSP + 8]\n");

  printf("mov [STATE_PTR + %lu], AH\n", offsetof(State, gpr.rax.byte.high));
  printf("mov [STATE_PTR + %lu], BH\n", offsetof(State, gpr.rbx.byte.high));
  printf("mov [STATE_PTR + %lu], CH\n", offsetof(State, gpr.rcx.byte.high));
  printf("mov [STATE_PTR + %lu], DH\n", offsetof(State, gpr.rdx.byte.high));
  printf("mov [STATE_PTR + %lu], AL\n", offsetof(State, gpr.rax.byte.low));
  printf("mov [STATE_PTR + %lu], BL\n", offsetof(State, gpr.rbx.byte.low));
  printf("mov [STATE_PTR + %lu], CL\n", offsetof(State, gpr.rcx.byte.low));
  printf("mov [STATE_PTR + %lu], DL\n", offsetof(State, gpr.rdx.byte.low));
  printf("#if 64 == ADDRESS_SIZE_BITS\n");
  printf("mov [STATE_PTR + %lu], SIL\n", offsetof(State, gpr.rsi.byte.low));
  printf("mov [STATE_PTR + %lu], DIL\n", offsetof(State, gpr.rdi.byte.low));
  printf("mov [STATE_PTR + %lu], SPL\n", offsetof(State, gpr.rsp.byte.low));
  printf("mov [STATE_PTR + %lu], BPL\n", offsetof(State, gpr.rbp.byte.low));
  printf("mov [STATE_PTR + %lu], R8B\n", offsetof(State, gpr.r8.byte.low));
  printf("mov [STATE_PTR + %lu], R9B\n", offsetof(State, gpr.r9.byte.low));
  printf("mov [STATE_PTR + %lu], R10B\n", offsetof(State, gpr.r10.byte.low));
  printf("mov [STATE_PTR + %lu], R11B\n", offsetof(State, gpr.r11.byte.low));
  printf("mov [STATE_PTR + %lu], R12B\n", offsetof(State, gpr.r12.byte.low));
  printf("mov [STATE_PTR + %lu], R13B\n", offsetof(State, gpr.r13.byte.low));
  printf("mov [STATE_PTR + %lu], R14B\n", offsetof(State, gpr.r14.byte.low));
  printf("mov [STATE_PTR + %lu], R15B\n", offsetof(State, gpr.r15.byte.low));
  printf("#endif  /* 64 == ADDRESS_SIZE_BITS */\n");
  printf("mov [STATE_PTR + %lu], AX\n", offsetof(State, gpr.rax.word));
  printf("mov [STATE_PTR + %lu], BX\n", offsetof(State, gpr.rbx.word));
  printf("mov [STATE_PTR + %lu], CX\n", offsetof(State, gpr.rcx.word));
  printf("mov [STATE_PTR + %lu], DX\n", offsetof(State, gpr.rdx.word));
  printf("mov [STATE_PTR + %lu], SI\n", offsetof(State, gpr.rsi.word));
  printf("mov [STATE_PTR + %lu], DI\n", offsetof(State, gpr.rdi.word));
  printf("mov [STATE_PTR + %lu], SP\n", offsetof(State, gpr.rsp.word));
  printf("mov [STATE_PTR + %lu], BP\n", offsetof(State, gpr.rbp.word));
  printf("#if 64 == ADDRESS_SIZE_BITS\n");
  printf("mov [STATE_PTR + %lu], R8W\n", offsetof(State, gpr.r8.word));
  printf("mov [STATE_PTR + %lu], R9W\n", offsetof(State, gpr.r9.word));
  printf("mov [STATE_PTR + %lu], R10W\n", offsetof(State, gpr.r10.word));
  printf("mov [STATE_PTR + %lu], R11W\n", offsetof(State, gpr.r11.word));
  printf("mov [STATE_PTR + %lu], R12W\n", offsetof(State, gpr.r12.word));
  printf("mov [STATE_PTR + %lu], R13W\n", offsetof(State, gpr.r13.word));
  printf("mov [STATE_PTR + %lu], R14W\n", offsetof(State, gpr.r14.word));
  printf("mov [STATE_PTR + %lu], R15W\n", offsetof(State, gpr.r15.word));
  printf("#endif  /* 64 == ADDRESS_SIZE_BITS */\n");
  printf("mov WORD PTR [STATE_PTR + %lu], 0\n", offsetof(State, gpr.rip.word));
  printf("mov [STATE_PTR + %lu], EAX\n", offsetof(State, gpr.rax.dword));
  printf("mov [STATE_PTR + %lu], EBX\n", offsetof(State, gpr.rbx.dword));
  printf("mov [STATE_PTR + %lu], ECX\n", offsetof(State, gpr.rcx.dword));
  printf("mov [STATE_PTR + %lu], EDX\n", offsetof(State, gpr.rdx.dword));
  printf("mov [STATE_PTR + %lu], ESI\n", offsetof(State, gpr.rsi.dword));
  printf("mov [STATE_PTR + %lu], EDI\n", offsetof(State, gpr.rdi.dword));
  printf("mov [STATE_PTR + %lu], ESP\n", offsetof(State, gpr.rsp.dword));
  printf("mov [STATE_PTR + %lu], EBP\n", offsetof(State, gpr.rbp.dword));

  printf("#if 64 == ADDRESS_SIZE_BITS\n");
  printf("mov [STATE_PTR + %lu], R8D\n", offsetof(State, gpr.r8.dword));
  printf("mov [STATE_PTR + %lu], R9D\n", offsetof(State, gpr.r9.dword));
  printf("mov [STATE_PTR + %lu], R10D\n", offsetof(State, gpr.r10.dword));
  printf("mov [STATE_PTR + %lu], R11D\n", offsetof(State, gpr.r11.dword));
  printf("mov [STATE_PTR + %lu], R12D\n", offsetof(State, gpr.r12.dword));
  printf("mov [STATE_PTR + %lu], R13D\n", offsetof(State, gpr.r13.dword));
  printf("mov [STATE_PTR + %lu], R14D\n", offsetof(State, gpr.r14.dword));
  printf("mov [STATE_PTR + %lu], R15D\n", offsetof(State, gpr.r15.dword));

  printf("mov [STATE_PTR + %lu], RAX\n", offsetof(State, gpr.rax.qword));
  printf("mov [STATE_PTR + %lu], RBX\n", offsetof(State, gpr.rbx.qword));
  printf("mov [STATE_PTR + %lu], RCX\n", offsetof(State, gpr.rcx.qword));
  printf("mov [STATE_PTR + %lu], RDX\n", offsetof(State, gpr.rdx.qword));
  printf("mov [STATE_PTR + %lu], RSI\n", offsetof(State, gpr.rsi.qword));
  printf("mov [STATE_PTR + %lu], RDI\n", offsetof(State, gpr.rdi.qword));
  printf("mov [STATE_PTR + %lu], RSP\n", offsetof(State, gpr.rsp.qword));
  printf("mov [STATE_PTR + %lu], RBP\n", offsetof(State, gpr.rbp.qword));
  printf("mov [STATE_PTR + %lu], R8\n", offsetof(State, gpr.r8.qword));
  printf("mov [STATE_PTR + %lu], R9\n", offsetof(State, gpr.r9.qword));
  printf("mov [STATE_PTR + %lu], R10\n", offsetof(State, gpr.r10.qword));
  printf("mov [STATE_PTR + %lu], R11\n", offsetof(State, gpr.r11.qword));
  printf("mov [STATE_PTR + %lu], R12\n", offsetof(State, gpr.r12.qword));
  printf("mov [STATE_PTR + %lu], R13\n", offsetof(State, gpr.r13.qword));
  printf("mov [STATE_PTR + %lu], R14\n", offsetof(State, gpr.r14.qword));
  printf("mov [STATE_PTR + %lu], R15\n", offsetof(State, gpr.r15.qword));
  printf("#endif  /* 64 == ADDRESS_SIZE_BITS */\n");

  printf("#if HAS_FEATURE_AVX\n");
  printf("#if HAS_FEATURE_AVX512\n");
  printf("mov [STATE_PTR + %lu], ZMM0\n", offsetof(State, vec[0].zmm));
  printf("mov [STATE_PTR + %lu], ZMM1\n", offsetof(State, vec[1].zmm));
  printf("mov [STATE_PTR + %lu], ZMM2\n", offsetof(State, vec[2].zmm));
  printf("mov [STATE_PTR + %lu], ZMM3\n", offsetof(State, vec[3].zmm));
  printf("mov [STATE_PTR + %lu], ZMM4\n", offsetof(State, vec[4].zmm));
  printf("mov [STATE_PTR + %lu], ZMM5\n", offsetof(State, vec[5].zmm));
  printf("mov [STATE_PTR + %lu], ZMM6\n", offsetof(State, vec[6].zmm));
  printf("mov [STATE_PTR + %lu], ZMM7\n", offsetof(State, vec[7].zmm));
  printf("mov [STATE_PTR + %lu], ZMM8\n", offsetof(State, vec[8].zmm));
  printf("mov [STATE_PTR + %lu], ZMM9\n", offsetof(State, vec[9].zmm));
  printf("mov [STATE_PTR + %lu], ZMM10\n", offsetof(State, vec[10].zmm));
  printf("mov [STATE_PTR + %lu], ZMM11\n", offsetof(State, vec[11].zmm));
  printf("mov [STATE_PTR + %lu], ZMM12\n", offsetof(State, vec[12].zmm));
  printf("mov [STATE_PTR + %lu], ZMM13\n", offsetof(State, vec[13].zmm));
  printf("mov [STATE_PTR + %lu], ZMM14\n", offsetof(State, vec[14].zmm));
  printf("mov [STATE_PTR + %lu], ZMM15\n", offsetof(State, vec[15].zmm));
  printf("mov [STATE_PTR + %lu], ZMM16\n", offsetof(State, vec[16].zmm));
  printf("mov [STATE_PTR + %lu], ZMM17\n", offsetof(State, vec[17].zmm));
  printf("mov [STATE_PTR + %lu], ZMM18\n", offsetof(State, vec[18].zmm));
  printf("mov [STATE_PTR + %lu], ZMM19\n", offsetof(State, vec[19].zmm));
  printf("mov [STATE_PTR + %lu], ZMM20\n", offsetof(State, vec[20].zmm));
  printf("mov [STATE_PTR + %lu], ZMM21\n", offsetof(State, vec[21].zmm));
  printf("mov [STATE_PTR + %lu], ZMM22\n", offsetof(State, vec[22].zmm));
  printf("mov [STATE_PTR + %lu], ZMM23\n", offsetof(State, vec[23].zmm));
  printf("mov [STATE_PTR + %lu], ZMM24\n", offsetof(State, vec[24].zmm));
  printf("mov [STATE_PTR + %lu], ZMM25\n", offsetof(State, vec[25].zmm));
  printf("mov [STATE_PTR + %lu], ZMM26\n", offsetof(State, vec[26].zmm));
  printf("mov [STATE_PTR + %lu], ZMM27\n", offsetof(State, vec[27].zmm));
  printf("mov [STATE_PTR + %lu], ZMM28\n", offsetof(State, vec[28].zmm));
  printf("mov [STATE_PTR + %lu], ZMM29\n", offsetof(State, vec[29].zmm));
  printf("mov [STATE_PTR + %lu], ZMM30\n", offsetof(State, vec[30].zmm));
  printf("mov [STATE_PTR + %lu], ZMM31\n", offsetof(State, vec[31].zmm));
  printf("#endif  /* HAS_FEATURE_AVX512 */\n");

  printf("vmovdqu [STATE_PTR + %lu], YMM0\n", offsetof(State, vec[0].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM1\n", offsetof(State, vec[1].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM2\n", offsetof(State, vec[2].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM3\n", offsetof(State, vec[3].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM4\n", offsetof(State, vec[4].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM5\n", offsetof(State, vec[5].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM6\n", offsetof(State, vec[6].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM7\n", offsetof(State, vec[7].ymm));
  printf("#if HAS_FEATURE_AVX || 64 == ADDRESS_SIZE_BITS\n");
  printf("vmovdqu [STATE_PTR + %lu], YMM8\n", offsetof(State, vec[8].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM9\n", offsetof(State, vec[9].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM10\n", offsetof(State, vec[10].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM11\n", offsetof(State, vec[11].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM12\n", offsetof(State, vec[12].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM13\n", offsetof(State, vec[13].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM14\n", offsetof(State, vec[14].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM15\n", offsetof(State, vec[15].ymm));
  printf("#endif  /* HAS_FEATURE_AVX || 64 == ADDRESS_SIZE_BITS */\n");

  printf("#if HAS_FEATURE_AVX512\n");
  printf("vmovdqu [STATE_PTR + %lu], YMM16\n", offsetof(State, vec[16].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM17\n", offsetof(State, vec[17].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM18\n", offsetof(State, vec[18].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM19\n", offsetof(State, vec[19].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM20\n", offsetof(State, vec[20].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM21\n", offsetof(State, vec[21].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM22\n", offsetof(State, vec[22].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM23\n", offsetof(State, vec[23].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM24\n", offsetof(State, vec[24].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM25\n", offsetof(State, vec[25].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM26\n", offsetof(State, vec[26].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM27\n", offsetof(State, vec[27].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM28\n", offsetof(State, vec[28].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM29\n", offsetof(State, vec[29].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM30\n", offsetof(State, vec[30].ymm));
  printf("vmovdqu [STATE_PTR + %lu], YMM31\n", offsetof(State, vec[31].ymm));
  printf("#endif  /* HAS_FEATURE_AVX512 */\n");
  printf("#endif  /* HAS_FEATURE_AVX */\n");

  printf("movdqu [STATE_PTR + %lu], XMM0\n", offsetof(State, vec[0].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM1\n", offsetof(State, vec[1].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM2\n", offsetof(State, vec[2].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM3\n", offsetof(State, vec[3].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM4\n", offsetof(State, vec[4].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM5\n", offsetof(State, vec[5].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM6\n", offsetof(State, vec[6].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM7\n", offsetof(State, vec[7].xmm));
  printf("#if HAS_FEATURE_AVX || 64 == ADDRESS_SIZE_BITS\n");
  printf("movdqu [STATE_PTR + %lu], XMM8\n", offsetof(State, vec[8].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM9\n", offsetof(State, vec[9].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM10\n", offsetof(State, vec[10].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM11\n", offsetof(State, vec[11].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM12\n", offsetof(State, vec[12].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM13\n", offsetof(State, vec[13].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM14\n", offsetof(State, vec[14].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM15\n", offsetof(State, vec[15].xmm));
  printf("#endif  /* HAS_FEATURE_AVX || 64 == ADDRESS_SIZE_BITS */\n");

  printf("#if HAS_FEATURE_AVX512\n");
  printf("movdqu [STATE_PTR + %lu], XMM16\n", offsetof(State, vec[16].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM17\n", offsetof(State, vec[17].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM18\n", offsetof(State, vec[18].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM19\n", offsetof(State, vec[19].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM20\n", offsetof(State, vec[20].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM21\n", offsetof(State, vec[21].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM22\n", offsetof(State, vec[22].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM23\n", offsetof(State, vec[23].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM24\n", offsetof(State, vec[24].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM25\n", offsetof(State, vec[25].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM26\n", offsetof(State, vec[26].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM27\n", offsetof(State, vec[27].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM28\n", offsetof(State, vec[28].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM29\n", offsetof(State, vec[29].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM30\n", offsetof(State, vec[30].xmm));
  printf("movdqu [STATE_PTR + %lu], XMM31\n", offsetof(State, vec[31].xmm));
  printf("#endif  // HAS_FEATURE_AVX512\n");
