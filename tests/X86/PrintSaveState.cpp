...
int main(void) {
  ...
  printf("mov [RIP + STATE_PTR + %lu], ZMM0\n", offsetof(State, vec[0].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM1\n", offsetof(State, vec[1].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM2\n", offsetof(State, vec[2].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM3\n", offsetof(State, vec[3].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM4\n", offsetof(State, vec[4].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM5\n", offsetof(State, vec[5].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM6\n", offsetof(State, vec[6].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM7\n", offsetof(State, vec[7].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM8\n", offsetof(State, vec[8].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM9\n", offsetof(State, vec[9].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM10\n", offsetof(State, vec[10].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM11\n", offsetof(State, vec[11].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM12\n", offsetof(State, vec[12].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM13\n", offsetof(State, vec[13].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM14\n", offsetof(State, vec[14].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM15\n", offsetof(State, vec[15].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM16\n", offsetof(State, vec[16].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM17\n", offsetof(State, vec[17].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM18\n", offsetof(State, vec[18].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM19\n", offsetof(State, vec[19].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM20\n", offsetof(State, vec[20].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM21\n", offsetof(State, vec[21].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM22\n", offsetof(State, vec[22].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM23\n", offsetof(State, vec[23].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM24\n", offsetof(State, vec[24].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM25\n", offsetof(State, vec[25].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM26\n", offsetof(State, vec[26].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM27\n", offsetof(State, vec[27].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM28\n", offsetof(State, vec[28].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM29\n", offsetof(State, vec[29].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM30\n", offsetof(State, vec[30].zmm));
  printf("mov [RIP + STATE_PTR + %lu], ZMM31\n", offsetof(State, vec[31].zmm));
