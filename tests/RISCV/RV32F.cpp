...
TEST(RISCV32, FaddS_WritesLow32BitsAndZeroExtends) {
  ...
  riscv::test::ExecuteOne<remill::ArchName::kArchRISCV32>(
      lifter, "riscv32_fadd_s_f3_f1_f2", riscv::Bytes32(word), /*addr=*/0x1000,
      &st, &mem);
...
TEST(RISCV32, FlwAndFsw_RoundTrip) {
  ...
  const auto flw =
      riscv::EncodeI(riscv::kOpcodeLoadFp, /*rd=*/1, /*funct3=*/0x2,
                     /*rs1=*/10, /*imm12=*/0);
  riscv::test::ExecuteOne<remill::ArchName::kArchRISCV32>(
      lifter, "riscv32_flw_f1_x10_0", riscv::Bytes32(flw), /*addr=*/0x2000, &st,
      &mem);
  ...
  const auto fsw =
      riscv::EncodeS(riscv::kOpcodeStoreFp, /*funct3=*/0x2, /*rs1=*/11,
                     /*rs2=*/1, /*imm12=*/0);
  riscv::test::ExecuteOne<remill::ArchName::kArchRISCV32>(
      lifter, "riscv32_fsw_f1_x11_0", riscv::Bytes32(fsw), /*addr=*/0x2004, &st,
      &mem);
