...
// CSET / CINC are CSINC aliases (with !cond folded in by the
// decoder, which passes invert_cond=true). Same semantic body.
DEF_COND_ISEL(CSET_CSINC_32_CONDSEL, CSINC, R32W, R32, R32)
DEF_COND_ISEL(CSET_CSINC_64_CONDSEL, CSINC, R64W, R64, R64)
DEF_COND_ISEL(CINC_CSINC_32_CONDSEL, CSINC, R32W, R32, R32)
DEF_COND_ISEL(CINC_CSINC_64_CONDSEL, CSINC, R64W, R64, R64)
...
// CINV / CSETM are CSINV aliases with !cond.
DEF_COND_ISEL(CINV_CSINV_32_CONDSEL, CSINV, R32W, R32, R32)
DEF_COND_ISEL(CINV_CSINV_64_CONDSEL, CSINV, R64W, R64, R64)
DEF_COND_ISEL(CSETM_CSINV_32_CONDSEL, CSINV, R32W, R32, R32)
DEF_COND_ISEL(CSETM_CSINV_64_CONDSEL, CSINV, R64W, R64, R64)
