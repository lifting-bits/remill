...
#ifndef REMILL_BUILD_SEMANTICS_DIR_RISCV32
#  error \
      "Macro `REMILL_BUILD_SEMANTICS_DIR_RISCV32` must be defined to support the RISCV32 architecture."
#  define REMILL_BUILD_SEMANTICS_DIR_RISCV32
#endif  // REMILL_BUILD_SEMANTICS_DIR_RISCV32

#ifndef REMILL_BUILD_SEMANTICS_DIR_RISCV64
#  error \
      "Macro `REMILL_BUILD_SEMANTICS_DIR_RISCV64` must be defined to support the RISCV64 architecture."
#  define REMILL_BUILD_SEMANTICS_DIR_RISCV64
#endif  // REMILL_BUILD_SEMANTICS_DIR_RISCV64
...
const paths_t &DefaultSemanticsSearchPaths() {
  static const paths_t paths = {
      ...
      REMILL_BUILD_SEMANTICS_DIR_RISCV32,
      REMILL_BUILD_SEMANTICS_DIR_RISCV64,
...
llvm::Value *LoadFromMemory(const IntrinsicTable &intrinsics,
  ...
  switch (type->getTypeID()) {
    case llvm::Type::HalfTyID: {
      ...
      auto converter = llvm::Intrinsic::getOrInsertDeclaration(
