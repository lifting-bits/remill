...
DEF_ISEL(CMEQ_ASIMDSAME_ONLY_1D) = CMPEQ_64<V64, uint64v1_t>;
DEF_ISEL(CMGT_ASIMDSAME_ONLY_1D) = CMPGT_64<V64, uint64v1_t>;
DEF_ISEL(CMGE_ASIMDSAME_ONLY_1D) = CMPGE_64<V64, uint64v1_t>;
DEF_ISEL(CMTST_ASIMDSAME_ONLY_1D) = CMPTST_64<V64, uint64v1_t>;
