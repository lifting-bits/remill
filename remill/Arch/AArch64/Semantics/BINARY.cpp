...
DEF_ISEL(ADD_32_ADDSUB_EXT) = ADD<R32W, R32, R32>;
DEF_ISEL(ADD_64_ADDSUB_EXT) = ADD<R64W, R64, R64>;
...
DEF_ISEL(SUB_32_ADDSUB_EXT) = SUB<R32W, R32, R32>;
DEF_ISEL(SUB_64_ADDSUB_EXT) = SUB<R64W, R64, R64>;
