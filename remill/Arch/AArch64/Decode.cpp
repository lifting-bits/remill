...
//  31 0 sf       0
// REV  <Wd>, <Wn>
bool TryDecodeREV_32_DP_1SRC(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 M        0
// FCVT  <Dd>, <Sn>
bool TryDecodeFCVT_DS_FLOATDP1(const InstData &, Instruction &) {
  return false;
}

// FCVT FCVT_HD_floatdp1:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0 M        0
// FCVT  <Hd>, <Dn>
bool TryDecodeFCVT_HD_FLOATDP1(const InstData &, Instruction &) {
  return false;
}

// FCVT FCVT_SD_floatdp1:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0 M        0
// FCVT  <Sd>, <Dn>
bool TryDecodeFCVT_SD_FLOATDP1(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 size     1
// LDUR  <Bt>, [<Xn|SP>{, #<simm>}]
bool TryDecodeLDUR_B_LDST_UNSCALED(const InstData &, Instruction &) {
  return false;
}

// LDUR LDUR_H_ldst_unscaled:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 0 size     1
// LDUR  <Ht>, [<Xn|SP>{, #<simm>}]
bool TryDecodeLDUR_H_LDST_UNSCALED(const InstData &, Instruction &) {
  return false;
}

// LDUR LDUR_S_ldst_unscaled:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 1 size     1
// LDUR  <St>, [<Xn|SP>{, #<simm>}]
bool TryDecodeLDUR_S_LDST_UNSCALED(const InstData &, Instruction &) {
  return false;
}

// LDUR LDUR_D_ldst_unscaled:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 1 size     1
// LDUR  <Dt>, [<Xn|SP>{, #<simm>}]
bool TryDecodeLDUR_D_LDST_UNSCALED(const InstData &, Instruction &) {
  return false;
}

// LDUR LDUR_Q_ldst_unscaled:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 0 size     1
// LDUR  <Qt>, [<Xn|SP>{, #<simm>}]
bool TryDecodeLDUR_Q_LDST_UNSCALED(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 size     1
// LDRSH  <Wt>, [<Xn|SP>], #<simm>
bool TryDecodeLDRSH_32_LDST_IMMPOST(const InstData &, Instruction &) {
  return false;
}

// LDRSH LDRSH_64_ldst_immpost:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 0 size     1
// LDRSH  <Xt>, [<Xn|SP>], #<simm>
bool TryDecodeLDRSH_64_LDST_IMMPOST(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 size     1
// LDRSH  <Wt>, [<Xn|SP>, #<simm>]!
bool TryDecodeLDRSH_32_LDST_IMMPRE(const InstData &, Instruction &) {
  return false;
}

// LDRSH LDRSH_64_ldst_immpre:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 0 size     1
// LDRSH  <Xt>, [<Xn|SP>, #<simm>]!
bool TryDecodeLDRSH_64_LDST_IMMPRE(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 size     1
// LDRSH  <Wt>, [<Xn|SP>{, #<pimm>}]
bool TryDecodeLDRSH_32_LDST_POS(const InstData &, Instruction &) {
  return false;
}

// LDRSH LDRSH_64_ldst_pos:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 0 size     1
// LDRSH  <Xt>, [<Xn|SP>{, #<pimm>}]
bool TryDecodeLDRSH_64_LDST_POS(const InstData &, Instruction &) {
  return false;
}
...
//  31 0
// ORR  <Vd>.<T>, <Vn>.<T>, <Vm>.<T>
bool TryDecodeORR_ASIMDSAME_ONLY(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeCCMN_32_CONDCMP_IMM(const InstData &, Instruction &) {
  return false;
}

// CCMN CCMN_64_condcmp_imm:
//   0 x nzcv     0
//   1 x nzcv     1
//   2 x nzcv     2
//   3 x nzcv     3
...
bool TryDecodeCCMN_64_CONDCMP_IMM(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 size     1
// STRH  <Wt>, [<Xn|SP>], #<simm>
bool TryDecodeSTRH_32_LDST_IMMPOST(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 size     1
// STRH  <Wt>, [<Xn|SP>, #<simm>]!
bool TryDecodeSTRH_32_LDST_IMMPRE(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 sf       0
// SCVTF  <Hd>, <Wn>
bool TryDecodeSCVTF_H32_FLOAT2INT(const InstData &, Instruction &) {
  return false;
}

// SCVTF SCVTF_S32_float2int:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0 sf       0
// SCVTF  <Sd>, <Wn>
bool TryDecodeSCVTF_S32_FLOAT2INT(const InstData &, Instruction &) {
  return false;
}

// SCVTF SCVTF_D32_float2int:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0 sf       0
// SCVTF  <Dd>, <Wn>
bool TryDecodeSCVTF_D32_FLOAT2INT(const InstData &, Instruction &) {
  return false;
}

// SCVTF SCVTF_H64_float2int:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 1 sf       0
// SCVTF  <Hd>, <Xn>
bool TryDecodeSCVTF_H64_FLOAT2INT(const InstData &, Instruction &) {
  return false;
}

// SCVTF SCVTF_S64_float2int:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 1 sf       0
// SCVTF  <Sd>, <Xn>
bool TryDecodeSCVTF_S64_FLOAT2INT(const InstData &, Instruction &) {
  return false;
}

// SCVTF SCVTF_D64_float2int:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 1 sf       0
// SCVTF  <Dd>, <Xn>
bool TryDecodeSCVTF_D64_FLOAT2INT(const InstData &, Instruction &) {
  return false;
}
...
//  31 0
// SMIN  <Vd>.<T>, <Vn>.<T>, <Vm>.<T>
bool TryDecodeSMIN_ASIMDSAME_ONLY(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeSMAXP_ASIMDSAME_ONLY(const InstData &, Instruction &) {
  return false;
}
...
//  31 0
// CMLT  <Vd>.<T>, <Vn>.<T>, #0
bool TryDecodeCMLT_ASIMDMISC_Z(const InstData &, Instruction &) {
  return false;
}
...
//  31 0
// CMGE  <Vd>.<T>, <Vn>.<T>, #0
bool TryDecodeCMGE_ASIMDMISC_Z(const InstData &, Instruction &) {
  return false;
}
...
//  31 0
// AND  <Vd>.<T>, <Vn>.<T>, <Vm>.<T>
bool TryDecodeAND_ASIMDSAME_ONLY(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeMVNI_ASIMDIMM_L_HL(const InstData &, Instruction &) {
  return false;
}

// MVNI MVNI_asimdimm_L_sl:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0
// MVNI  <Vd>.<T>, #<imm8>{, LSL #<amount>}
bool TryDecodeMVNI_ASIMDIMM_L_SL(const InstData &, Instruction &) {
  return false;
}

// MVNI MVNI_asimdimm_M_sm:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
bool TryDecodeMVNI_ASIMDIMM_M_SM(const InstData &, Instruction &) {
  return false;
}
...
//  31 0
// UMIN  <Vd>.<T>, <Vn>.<T>, <Vm>.<T>
bool TryDecodeUMIN_ASIMDSAME_ONLY(const InstData &, Instruction &) {
  return false;
}
...
//  31 0
// SMOV  <Wd>, <Vn>.<Ts>[<index>]
bool TryDecodeSMOV_ASIMDINS_W_W(const InstData &, Instruction &) {
  return false;
}

// SMOV SMOV_asimdins_X_x:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0
// SMOV  <Xd>, <Vn>.<Ts>[<index>]
bool TryDecodeSMOV_ASIMDINS_X_X(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 size     1
// LDARH  <Wt>, [<Xn|SP>{,#0}]
bool TryDecodeLDARH_LR32_LDSTEXCL(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 M        0
// FSUB  <Hd>, <Hn>, <Hm>
bool TryDecodeFSUB_H_FLOATDP2(const InstData &, Instruction &) {
  return false;
}

// FSUB FSUB_S_floatdp2:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0 M        0
// FSUB  <Sd>, <Sn>, <Sm>
bool TryDecodeFSUB_S_FLOATDP2(const InstData &, Instruction &) {
  return false;
}

// FSUB FSUB_D_floatdp2:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0 M        0
// FSUB  <Dd>, <Dn>, <Dm>
bool TryDecodeFSUB_D_FLOATDP2(const InstData &, Instruction &) {
  return false;
}
...
//  31 1 sf       0
// REV32  <Xd>, <Xn>
bool TryDecodeREV32_64_DP_1SRC(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 M        0
// FMUL  <Hd>, <Hn>, <Hm>
bool TryDecodeFMUL_H_FLOATDP2(const InstData &, Instruction &) {
  return false;
}

// FMUL FMUL_S_floatdp2:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0 M        0
// FMUL  <Sd>, <Sn>, <Sm>
bool TryDecodeFMUL_S_FLOATDP2(const InstData &, Instruction &) {
  return false;
}

// FMUL FMUL_D_floatdp2:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0 M        0
// FMUL  <Dd>, <Dn>, <Dm>
bool TryDecodeFMUL_D_FLOATDP2(const InstData &, Instruction &) {
  return false;
}

// LDAXR LDAXR_LR32_ldstexcl:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 1 size     1
// LDAXR  <Wt>, [<Xn|SP>{,#0}]
bool TryDecodeLDAXR_LR32_LDSTEXCL(const InstData &, Instruction &) {
  return false;
}

// LDAXR LDAXR_LR64_ldstexcl:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 1 size     1
// LDAXR  <Xt>, [<Xn|SP>{,#0}]
bool TryDecodeLDAXR_LR64_LDSTEXCL(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeUMINP_ASIMDSAME_ONLY(const InstData &, Instruction &) {
  return false;
}
...
//  31 0
// CMLE  <Vd>.<T>, <Vn>.<T>, #0
bool TryDecodeCMLE_ASIMDMISC_Z(const InstData &, Instruction &) {
  return false;
}
...
//  31 0
// CMEQ  <Vd>.<T>, <Vn>.<T>, #0
bool TryDecodeCMEQ_ASIMDMISC_Z(const InstData &, Instruction &) {
  return false;
}
...
//  31 1 opc      1
// LDRSW  <Xt>, <label>
bool TryDecodeLDRSW_64_LOADLIT(const InstData &, Instruction &) {
  return false;
}
...
//  31 1 size     1
// STUR  <Wt>, [<Xn|SP>{, #<simm>}]
bool TryDecodeSTUR_32_LDST_UNSCALED(const InstData &, Instruction &) {
  return false;
}

// STUR STUR_64_ldst_unscaled:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 1 size     1
// STUR  <Xt>, [<Xn|SP>{, #<simm>}]
bool TryDecodeSTUR_64_LDST_UNSCALED(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 size     1
// STR  <Qt>, [<Xn|SP>, #<simm>]!
bool TryDecodeSTR_Q_LDST_IMMPRE(const InstData &, Instruction &) {
  return false;
}
...
//  31 0
// INS  <Vd>.<Ts>[<index>], <R><n>
bool TryDecodeINS_ASIMDINS_IR_R(const InstData &, Instruction &) {
  return false;
}
...
//  31 0
// CMGT  <Vd>.<T>, <Vn>.<T>, #0
bool TryDecodeCMGT_ASIMDMISC_Z(const InstData &, Instruction &) {
  return false;
}
...
//  31 0
// CMEQ  <Vd>.<T>, <Vn>.<T>, <Vm>.<T>
bool TryDecodeCMEQ_ASIMDSAME_ONLY(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeSTRH_32_LDST_REGOFF(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 size     1
// STRB  <Wt>, [<Xn|SP>], #<simm>
bool TryDecodeSTRB_32_LDST_IMMPOST(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 size     1
// STRB  <Wt>, [<Xn|SP>, #<simm>]!
bool TryDecodeSTRB_32_LDST_IMMPRE(const InstData &, Instruction &) {
  return false;
}
...
//  31 0
// ADDP  <Vd>.<T>, <Vn>.<T>, <Vm>.<T>
bool TryDecodeADDP_ASIMDSAME_ONLY(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeBICS_32_LOG_SHIFT(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeBICS_64_LOG_SHIFT(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeSMINP_ASIMDSAME_ONLY(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 sf       0
// SDIV  <Wd>, <Wn>, <Wm>
bool TryDecodeSDIV_32_DP_2SRC(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 sf       0
// RBIT  <Wd>, <Wn>
bool TryDecodeRBIT_32_DP_1SRC(const InstData &, Instruction &) {
  return false;
}

// RBIT RBIT_64_dp_1src:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 1 sf       0
// RBIT  <Xd>, <Xn>
bool TryDecodeRBIT_64_DP_1SRC(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 sf       0
// FMOV  <Sd>, <Wn>
bool TryDecodeFMOV_S32_FLOAT2INT(const InstData &, Instruction &) {
  return false;
}

// FMOV FMOV_32S_float2int:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0 sf       0
// FMOV  <Wd>, <Sn>
bool TryDecodeFMOV_32S_FLOAT2INT(const InstData &, Instruction &) {
  return false;
}
...
//  31 1 sf       0
// FMOV  <Dd>, <Xn>
bool TryDecodeFMOV_D64_FLOAT2INT(const InstData &, Instruction &) {
  return false;
}

// FMOV FMOV_V64I_float2int:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 1 sf       0
// FMOV  <Vd>.D[1], <Xn>
bool TryDecodeFMOV_V64I_FLOAT2INT(const InstData &, Instruction &) {
  return false;
}

// FMOV FMOV_64D_float2int:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 1 sf       0
// FMOV  <Xd>, <Dn>
bool TryDecodeFMOV_64D_FLOAT2INT(const InstData &, Instruction &) {
  return false;
}

// FMOV FMOV_64VX_float2int:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 1 sf       0
// FMOV  <Xd>, <Vn>.D[1]
bool TryDecodeFMOV_64VX_FLOAT2INT(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 M        0
// FMADD  <Sd>, <Sn>, <Sm>, <Sa>
bool TryDecodeFMADD_S_FLOATDP3(const InstData &, Instruction &) {
  return false;
}

// FMADD FMADD_D_floatdp3:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0 M        0
// FADD  <Hd>, <Hn>, <Hm>
bool TryDecodeFADD_H_FLOATDP2(const InstData &, Instruction &) {
  return false;
}

// FADD FADD_S_floatdp2:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0 M        0
// FADD  <Sd>, <Sn>, <Sm>
bool TryDecodeFADD_S_FLOATDP2(const InstData &, Instruction &) {
  return false;
}

// FADD FADD_D_floatdp2:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0 M        0
// FADD  <Dd>, <Dn>, <Dm>
bool TryDecodeFADD_D_FLOATDP2(const InstData &, Instruction &) {
  return false;
}
...
//  31 1 size     1
// LDXR  <Wt>, [<Xn|SP>{,#0}]
bool TryDecodeLDXR_LR32_LDSTEXCL(const InstData &, Instruction &) {
  return false;
}

// LDXR LDXR_LR64_ldstexcl:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 1 size     1
// LDXR  <Xt>, [<Xn|SP>{,#0}]
bool TryDecodeLDXR_LR64_LDSTEXCL(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 M        0
// FCMPE  <Hn>, <Hm>
bool TryDecodeFCMPE_H_FLOATCMP(const InstData &, Instruction &) {
  return false;
}

// FCMPE FCMPE_HZ_floatcmp:
//   0 0
//   1 0
//   2 0
//   3 1 opc      0
...
//  31 0 M        0
// FCMPE  <Hn>, #0.0
bool TryDecodeFCMPE_HZ_FLOATCMP(const InstData &, Instruction &) {
  return false;
}

// FCMPE FCMPE_S_floatcmp:
//   0 0
//   1 0
//   2 0
//   3 0 opc      0
...
//  31 0 M        0
// FCMPE  <Sn>, <Sm>
bool TryDecodeFCMPE_S_FLOATCMP(const InstData &, Instruction &) {
  return false;
}

// FCMPE FCMPE_SZ_floatcmp:
//   0 0
//   1 0
//   2 0
//   3 1 opc      0
...
//  31 0 M        0
// FCMPE  <Sn>, #0.0
bool TryDecodeFCMPE_SZ_FLOATCMP(const InstData &, Instruction &) {
  return false;
}

// FCMPE FCMPE_D_floatcmp:
//   0 0
//   1 0
//   2 0
//   3 0 opc      0
...
//  31 0 M        0
// FCMPE  <Dn>, <Dm>
bool TryDecodeFCMPE_D_FLOATCMP(const InstData &, Instruction &) {
  return false;
}

// FCMPE FCMPE_DZ_floatcmp:
//   0 0
//   1 0
//   2 0
//   3 1 opc      0
...
//  31 0 M        0
// FCMPE  <Dn>, #0.0
bool TryDecodeFCMPE_DZ_FLOATCMP(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 M        0
// FMOV  <Hd>, #<imm>
bool TryDecodeFMOV_H_FLOATIMM(const InstData &, Instruction &) {
  return false;
}

// FMOV FMOV_S_floatimm:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0 M        0
// FMOV  <Sd>, #<imm>
bool TryDecodeFMOV_S_FLOATIMM(const InstData &, Instruction &) {
  return false;
}

// FMOV FMOV_D_floatimm:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
bool TryDecodeLD2_ASISDLSE_R2(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeLD2_ASISDLSEP_I2_I(const InstData &, Instruction &) {
  return false;
}

// LD2 LD2_asisdlsep_R2_r:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
bool TryDecodeLD2_ASISDLSEP_R2_R(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeMOVI_ASIMDIMM_N_B(const InstData &, Instruction &) {
  return false;
}

// MOVI MOVI_asimdimm_L_hl:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
bool TryDecodeMOVI_ASIMDIMM_L_HL(const InstData &, Instruction &) {
  return false;
}

// MOVI MOVI_asimdimm_L_sl:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0
// MOVI  <Vd>.<T>, #<imm8>{, LSL #<amount>}
bool TryDecodeMOVI_ASIMDIMM_L_SL(const InstData &, Instruction &) {
  return false;
}

// MOVI MOVI_asimdimm_M_sm:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
bool TryDecodeMOVI_ASIMDIMM_M_SM(const InstData &, Instruction &) {
  return false;
}

// MOVI MOVI_asimdimm_D_ds:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0
// MOVI  <Dd>, #<imm>
bool TryDecodeMOVI_ASIMDIMM_D_DS(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 sf       0
// REV16  <Wd>, <Wn>
bool TryDecodeREV16_32_DP_1SRC(const InstData &, Instruction &) {
  return false;
}

// REV16 REV16_64_dp_1src:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 1 sf       0
// REV16  <Xd>, <Xn>
bool TryDecodeREV16_64_DP_1SRC(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 size     1
// LDRH  <Wt>, [<Xn|SP>], #<simm>
bool TryDecodeLDRH_32_LDST_IMMPOST(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 size     1
// LDRH  <Wt>, [<Xn|SP>, #<simm>]!
bool TryDecodeLDRH_32_LDST_IMMPRE(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 size     1
// LDRH  <Wt>, [<Xn|SP>{, #<pimm>}]
bool TryDecodeLDRH_32_LDST_POS(const InstData &, Instruction &) {
  return false;
}
...
//  31 0
// LD1  { <Vt>.<T> }, [<Xn|SP>]
bool TryDecodeLD1_ASISDLSE_R1_1V(const InstData &, Instruction &) {
  return false;
}

// LD1 LD1_asisdlse_R2_2v:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
bool TryDecodeLD1_ASISDLSE_R2_2V(const InstData &, Instruction &) {
  return false;
}

// LD1 LD1_asisdlse_R3_3v:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
bool TryDecodeLD1_ASISDLSE_R3_3V(const InstData &, Instruction &) {
  return false;
}

// LD1 LD1_asisdlse_R4_4v:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
bool TryDecodeLD1_ASISDLSE_R4_4V(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeLD1_ASISDLSEP_I2_I2(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeLD1_ASISDLSEP_I3_I3(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeLD1_ASISDLSEP_I4_I4(const InstData &, Instruction &) {
  return false;
}
...
//  31 0
// CMGT  <Vd>.<T>, <Vn>.<T>, <Vm>.<T>
bool TryDecodeCMGT_ASIMDSAME_ONLY(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeLDRSW_64_LDST_REGOFF(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 M        0
// FCMP  <Sn>, <Sm>
bool TryDecodeFCMP_S_FLOATCMP(const InstData &, Instruction &) {
  return false;
}

// FCMP FCMP_SZ_floatcmp:
//   0 0
//   1 0
//   2 0
//   3 1 opc      0
...
//  31 0 M        0
// FCMP  <Sn>, #0.0
bool TryDecodeFCMP_SZ_FLOATCMP(const InstData &, Instruction &) {
  return false;
}

// FCMP FCMP_D_floatcmp:
//   0 0
//   1 0
//   2 0
//   3 0 opc      0
...
//  31 0 M        0
// FCMP  <Dn>, <Dm>
bool TryDecodeFCMP_D_FLOATCMP(const InstData &, Instruction &) {
  return false;
}

// FCMP FCMP_DZ_floatcmp:
//   0 0
//   1 0
//   2 0
//   3 1 opc      0
...
//  31 0 M        0
// FCMP  <Dn>, #0.0
bool TryDecodeFCMP_DZ_FLOATCMP(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 sf       0
// MSUB  <Wd>, <Wn>, <Wm>, <Wa>
bool TryDecodeMSUB_32A_DP_3SRC(const InstData &, Instruction &) {
  return false;
}
...
//  31 1 sf       0
// MSUB  <Xd>, <Xn>, <Xm>, <Xa>
bool TryDecodeMSUB_64A_DP_3SRC(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeLD4_ASISDLSE_R4(const InstData &, Instruction &) {
  return false;
}
...
//  31 1 size     1
// LDR  <Wt>, [<Xn|SP>], #<simm>
bool TryDecodeLDR_32_LDST_IMMPOST(const InstData &, Instruction &) {
  return false;
}

// LDR LDR_64_ldst_immpost:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 1 size     1
// LDR  <Xt>, [<Xn|SP>], #<simm>
bool TryDecodeLDR_64_LDST_IMMPOST(const InstData &, Instruction &) {
  return false;
}
...
//  31 1 size     1
// LDR  <Wt>, [<Xn|SP>, #<simm>]!
bool TryDecodeLDR_32_LDST_IMMPRE(const InstData &, Instruction &) {
  return false;
}

// LDR LDR_64_ldst_immpre:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 1 size     1
// LDR  <Xt>, [<Xn|SP>, #<simm>]!
bool TryDecodeLDR_64_LDST_IMMPRE(const InstData &, Instruction &) {
  return false;
}
...
//  31 0
// USHR  <V><d>, <V><n>, #<shift>
bool TryDecodeUSHR_ASISDSHF_R(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeUSHR_ASIMDSHF_R(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 size     1
// STUR  <Bt>, [<Xn|SP>{, #<simm>}]
bool TryDecodeSTUR_B_LDST_UNSCALED(const InstData &, Instruction &) {
  return false;
}

// STUR STUR_H_ldst_unscaled:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 0 size     1
// STUR  <Ht>, [<Xn|SP>{, #<simm>}]
bool TryDecodeSTUR_H_LDST_UNSCALED(const InstData &, Instruction &) {
  return false;
}

// STUR STUR_S_ldst_unscaled:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 1 size     1
// STUR  <St>, [<Xn|SP>{, #<simm>}]
bool TryDecodeSTUR_S_LDST_UNSCALED(const InstData &, Instruction &) {
  return false;
}

// STUR STUR_D_ldst_unscaled:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 1 size     1
// STUR  <Dt>, [<Xn|SP>{, #<simm>}]
bool TryDecodeSTUR_D_LDST_UNSCALED(const InstData &, Instruction &) {
  return false;
}

// STUR STUR_Q_ldst_unscaled:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 0 size     1
// STUR  <Qt>, [<Xn|SP>{, #<simm>}]
bool TryDecodeSTUR_Q_LDST_UNSCALED(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 opc      1
// STP  <St1>, <St2>, [<Xn|SP>{, #<imm>}]
bool TryDecodeSTP_S_LDSTPAIR_OFF(const InstData &, Instruction &) {
  return false;
}

// STP STP_D_ldstpair_off:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 0 opc      1
// STP  <Dt1>, <Dt2>, [<Xn|SP>{, #<imm>}]
bool TryDecodeSTP_D_LDSTPAIR_OFF(const InstData &, Instruction &) {
  return false;
}

// STP STP_Q_ldstpair_off:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 1 opc      1
// STP  <Qt1>, <Qt2>, [<Xn|SP>{, #<imm>}]
bool TryDecodeSTP_Q_LDSTPAIR_OFF(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeSTRB_32B_LDST_REGOFF(const InstData &, Instruction &) {
  return false;
}

// STRB STRB_32BL_ldst_regoff:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
bool TryDecodeSTRB_32BL_LDST_REGOFF(const InstData &, Instruction &) {
  return false;
}
...
//  31 0
// UMAX  <Vd>.<T>, <Vn>.<T>, <Vm>.<T>
bool TryDecodeUMAX_ASIMDSAME_ONLY(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeUMAXP_ASIMDSAME_ONLY(const InstData &, Instruction &) {
  return false;
}
...
//  31 0
// SMAX  <Vd>.<T>, <Vn>.<T>, <Vm>.<T>
bool TryDecodeSMAX_ASIMDSAME_ONLY(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 size     1
// LDRB  <Wt>, [<Xn|SP>], #<simm>
bool TryDecodeLDRB_32_LDST_IMMPOST(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 size     1
// LDRB  <Wt>, [<Xn|SP>, #<simm>]!
bool TryDecodeLDRB_32_LDST_IMMPRE(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeLDRH_32_LDST_REGOFF(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 M        0
// FMOV  <Sd>, <Sn>
bool TryDecodeFMOV_S_FLOATDP1(const InstData &, Instruction &) {
  return false;
}

// FMOV FMOV_D_floatdp1:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0 M        0
// FMOV  <Dd>, <Dn>
bool TryDecodeFMOV_D_FLOATDP1(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeLDP_S_LDSTPAIR_POST(const InstData &, Instruction &) {
  return false;
}

// LDP LDP_D_ldstpair_post:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
bool TryDecodeLDP_D_LDSTPAIR_POST(const InstData &, Instruction &) {
  return false;
}

// LDP LDP_Q_ldstpair_post:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
bool TryDecodeLDP_Q_LDSTPAIR_POST(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 opc      1
// LDP  <St1>, <St2>, [<Xn|SP>, #<imm>]!
bool TryDecodeLDP_S_LDSTPAIR_PRE(const InstData &, Instruction &) {
  return false;
}

// LDP LDP_D_ldstpair_pre:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 0 opc      1
// LDP  <Dt1>, <Dt2>, [<Xn|SP>, #<imm>]!
bool TryDecodeLDP_D_LDSTPAIR_PRE(const InstData &, Instruction &) {
  return false;
}

// LDP LDP_Q_ldstpair_pre:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 1 opc      1
// LDP  <Qt1>, <Qt2>, [<Xn|SP>, #<imm>]!
bool TryDecodeLDP_Q_LDSTPAIR_PRE(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 opc      1
// LDP  <St1>, <St2>, [<Xn|SP>{, #<imm>}]
bool TryDecodeLDP_S_LDSTPAIR_OFF(const InstData &, Instruction &) {
  return false;
}

// LDP LDP_D_ldstpair_off:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 0 opc      1
// LDP  <Dt1>, <Dt2>, [<Xn|SP>{, #<imm>}]
bool TryDecodeLDP_D_LDSTPAIR_OFF(const InstData &, Instruction &) {
  return false;
}

// LDP LDP_Q_ldstpair_off:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 1 opc      1
// LDP  <Qt1>, <Qt2>, [<Xn|SP>{, #<imm>}]
bool TryDecodeLDP_Q_LDSTPAIR_OFF(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 sf       0
// FCVTZU  <Wd>, <Sn>
bool TryDecodeFCVTZU_32S_FLOAT2INT(const InstData &, Instruction &) {
  return false;
}

// FCVTZU FCVTZU_64S_float2int:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 1 sf       0
// FCVTZU  <Xd>, <Sn>
bool TryDecodeFCVTZU_64S_FLOAT2INT(const InstData &, Instruction &) {
  return false;
}

// FCVTZU FCVTZU_32D_float2int:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0 sf       0
// FCVTZU  <Wd>, <Dn>
bool TryDecodeFCVTZU_32D_FLOAT2INT(const InstData &, Instruction &) {
  return false;
}

// FCVTZU FCVTZU_64D_float2int:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 1 sf       0
// FCVTZU  <Xd>, <Dn>
bool TryDecodeFCVTZU_64D_FLOAT2INT(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 M        0
// FDIV  <Hd>, <Hn>, <Hm>
bool TryDecodeFDIV_H_FLOATDP2(const InstData &, Instruction &) {
  return false;
}

// FDIV FDIV_S_floatdp2:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0 M        0
// FDIV  <Sd>, <Sn>, <Sm>
bool TryDecodeFDIV_S_FLOATDP2(const InstData &, Instruction &) {
  return false;
}

// FDIV FDIV_D_floatdp2:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0 M        0
// FDIV  <Dd>, <Dn>, <Dm>
bool TryDecodeFDIV_D_FLOATDP2(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeLDRSH_32_LDST_REGOFF(const InstData &, Instruction &) {
  return false;
}

// LDRSH LDRSH_64_ldst_regoff:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 0 M        0
// FABS  <Sd>, <Sn>
bool TryDecodeFABS_S_FLOATDP1(const InstData &, Instruction &) {
  return false;
}

// FABS FABS_D_floatdp1:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0 M        0
// FABS  <Dd>, <Dn>
bool TryDecodeFABS_D_FLOATDP1(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 size     1
// LDARB  <Wt>, [<Xn|SP>{,#0}]
bool TryDecodeLDARB_LR32_LDSTEXCL(const InstData &, Instruction &) {
  return false;
}
...
//  31 0
// CMGE  <Vd>.<T>, <Vn>.<T>, <Vm>.<T>
bool TryDecodeCMGE_ASIMDSAME_ONLY(const InstData &, Instruction &) {
  return false;
}
...
//  31 0
// UMOV  <Wd>, <Vn>.<Ts>[<index>]
bool TryDecodeUMOV_ASIMDINS_W_W(const InstData &, Instruction &) {
  return false;
}

// UMOV UMOV_asimdins_X_x:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0
// UMOV  <Xd>, <Vn>.<Ts>[<index>]
bool TryDecodeUMOV_ASIMDINS_X_X(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 sf       0
// FCVTZS  <Wd>, <Sn>
bool TryDecodeFCVTZS_32S_FLOAT2INT(const InstData &, Instruction &) {
  return false;
}

// FCVTZS FCVTZS_64S_float2int:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 1 sf       0
// FCVTZS  <Xd>, <Sn>
bool TryDecodeFCVTZS_64S_FLOAT2INT(const InstData &, Instruction &) {
  return false;
}

// FCVTZS FCVTZS_32D_float2int:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0 sf       0
// FCVTZS  <Wd>, <Dn>
bool TryDecodeFCVTZS_32D_FLOAT2INT(const InstData &, Instruction &) {
  return false;
}

// FCVTZS FCVTZS_64D_float2int:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 1 sf       0
// FCVTZS  <Xd>, <Dn>
bool TryDecodeFCVTZS_64D_FLOAT2INT(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 size     1
// LDRSB  <Wt>, [<Xn|SP>], #<simm>
bool TryDecodeLDRSB_32_LDST_IMMPOST(const InstData &, Instruction &) {
  return false;
}

// LDRSB LDRSB_64_ldst_immpost:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 0 size     1
// LDRSB  <Xt>, [<Xn|SP>], #<simm>
bool TryDecodeLDRSB_64_LDST_IMMPOST(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 size     1
// LDRSB  <Wt>, [<Xn|SP>, #<simm>]!
bool TryDecodeLDRSB_32_LDST_IMMPRE(const InstData &, Instruction &) {
  return false;
}

// LDRSB LDRSB_64_ldst_immpre:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 0 size     1
// LDRSB  <Xt>, [<Xn|SP>, #<simm>]!
bool TryDecodeLDRSB_64_LDST_IMMPRE(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 size     1
// LDRSB  <Wt>, [<Xn|SP>{, #<pimm>}]
bool TryDecodeLDRSB_32_LDST_POS(const InstData &, Instruction &) {
  return false;
}

// LDRSB LDRSB_64_ldst_pos:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 0 size     1
// LDRSB  <Xt>, [<Xn|SP>{, #<pimm>}]
bool TryDecodeLDRSB_64_LDST_POS(const InstData &, Instruction &) {
  return false;
}
...
//  31 1 size     1
// LDAR  <Wt>, [<Xn|SP>{,#0}]
bool TryDecodeLDAR_LR32_LDSTEXCL(const InstData &, Instruction &) {
  return false;
}

// LDAR LDAR_LR64_ldstexcl:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
//  31 1 size     1
// LDAR  <Xt>, [<Xn|SP>{,#0}]
bool TryDecodeLDAR_LR64_LDSTEXCL(const InstData &, Instruction &) {
  return false;
}
...
//  31 1 size     1
// LDRSW  <Xt>, [<Xn|SP>], #<simm>
bool TryDecodeLDRSW_64_LDST_IMMPOST(const InstData &, Instruction &) {
  return false;
}
...
//  31 1 size     1
// LDRSW  <Xt>, [<Xn|SP>, #<simm>]!
bool TryDecodeLDRSW_64_LDST_IMMPRE(const InstData &, Instruction &) {
  return false;
}
...
//  31 1 size     1
// LDRSW  <Xt>, [<Xn|SP>{, #<pimm>}]
bool TryDecodeLDRSW_64_LDST_POS(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeLDRSB_32B_LDST_REGOFF(const InstData &, Instruction &) {
  return false;
}

// LDRSB LDRSB_32BL_ldst_regoff:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
bool TryDecodeLDRSB_32BL_LDST_REGOFF(const InstData &, Instruction &) {
  return false;
}

// LDRSB LDRSB_64B_ldst_regoff:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
bool TryDecodeLDRSB_64B_LDST_REGOFF(const InstData &, Instruction &) {
  return false;
}

// LDRSB LDRSB_64BL_ldst_regoff:
//   0 x Rt       0
//   1 x Rt       1
//   2 x Rt       2
//   3 x Rt       3
...
bool TryDecodeLDRSB_64BL_LDST_REGOFF(const InstData &, Instruction &) {
  return false;
}
...
//  31 0 M        0
// FNEG  <Sd>, <Sn>
bool TryDecodeFNEG_S_FLOATDP1(const InstData &, Instruction &) {
  return false;
}

// FNEG FNEG_D_floatdp1:
//   0 x Rd       0
//   1 x Rd       1
//   2 x Rd       2
//   3 x Rd       3
...
//  31 0 M        0
// FNEG  <Dd>, <Dn>
bool TryDecodeFNEG_D_FLOATDP1(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeCMTST_ASIMDSAME_ONLY(const InstData &, Instruction &) {
  return false;
}
...
bool TryDecodeSTR_Q_LDST_REGOFF(const InstData &, Instruction &) {
  return false;
}
