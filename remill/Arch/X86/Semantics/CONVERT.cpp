...
IF_AVX(DEF_ISEL(VCVTTPD2DQ_XMMdq_YMMqq) = CVTTPD2DQ_AVX<VV128W, V256>;)
...
DEF_SEM(CVTTPS2DQ, D dst, S1 src) {
  ...
  _Pragma("unroll")
  for (size_t i = 0; i < 4UL; ++i) {
    dst_vec = SInsertV32(dst_vec, i, Int32(FExtractV32(src_vec, i)));
  }
  SWriteV32(dst, dst_vec);
}
...
IF_AVX(DEF_ISEL(VCVTTPS2DQ_YMMqq_YMMqq) = CVTTPS2DQ_AVX<VV256W, V256>;)
...
DEF_ISEL(CVTPS2DQ_XMMdq_MEMps) = CVTTPS2DQ<V128W, MV128>;
DEF_ISEL(CVTPS2DQ_XMMdq_XMMps) = CVTTPS2DQ<V128W, V128>;
IF_AVX(DEF_ISEL(VCVTPS2DQ_XMMdq_MEMdq) = CVTTPS2DQ<VV128W, MV128>;)
IF_AVX(DEF_ISEL(VCVTPS2DQ_XMMdq_XMMdq) = CVTTPS2DQ<VV128W, V128>;)
IF_AVX(DEF_ISEL(VCVTPS2DQ_YMMqq_MEMqq) = CVTTPS2DQ_AVX<VV256W, MV256>;)
IF_AVX(DEF_ISEL(VCVTPS2DQ_YMMqq_YMMqq) = CVTTPS2DQ_AVX<VV256W, V256>;)

DEF_ISEL(CVTPD2DQ_XMMdq_MEMpd) = CVTTPD2DQ<V128W, MV128>;
DEF_ISEL(CVTPD2DQ_XMMdq_XMMpd) = CVTTPD2DQ<V128W, V128>;
IF_AVX(DEF_ISEL(VCVTPD2DQ_XMMdq_MEMdq) = CVTTPD2DQ<VV128W, MV128>;)
IF_AVX(DEF_ISEL(VCVTPD2DQ_XMMdq_XMMdq) = CVTTPD2DQ<VV128W, V128>;)
IF_AVX(DEF_ISEL(VCVTPD2DQ_XMMdq_MEMqq) = CVTTPD2DQ_AVX<VV128W, MV256>;)
IF_AVX(DEF_ISEL(VCVTPD2DQ_XMMdq_YMMqq) = CVTTPD2DQ_AVX<VV128W, V256>;)
