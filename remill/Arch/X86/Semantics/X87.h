...
DEF_ISEL_SEM(FICOM_ST0_MEMmem16int, RF80, M16 src1) {
  auto lhs = Read(src1);
  auto rhs = Float64(Signed(Read(src1)));
  uint16_t mask = 0;
  if (FCmpGt(lhs, rhs)) {
    mask = 0;
...
DEF_ISEL_SEM(FICOM_ST0_MEMmem32int, RF80 src1, M32 src2) {
  auto lhs = Read(src1);
...
DEF_ISEL_SEM(FICOMP_ST0_MEMmem16int, RF80 src1, M16 src2) {
  FICOM_ST0_MEMmem16int(state, memory, src1, src2);
  (void) POP_X87_STACK(_);
}

DEF_ISEL_SEM(FICOMP_ST0_MEMmem32int, RF80 src1, M32 src2) {
  FICOM_ST0_MEMmem32int(state, memory, src1, src2);
  (void) POP_X87_STACK(_);
}
...
1639 FUCOMP  X87_ALU X87 X87 ATTRIBUTES: NOTSX
...
366 FCOMPP FCOMPP_ST0_ST1 X87_ALU X87 X87 ATTRIBUTES: NOTSX
