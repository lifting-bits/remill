...
DEF_ISEL(CVTDQ2PD_XMMpd_MEMq) = CVTDQ2PD<V128W, MV64>;
DEF_ISEL(CVTDQ2PD_XMMpd_XMMq) = CVTDQ2PD<V128W, V128>;
IF_AVX(DEF_ISEL(VCVTDQ2PD_XMMdq_MEMq) = CVTDQ2PD<VV128W, MV64>;)
IF_AVX(DEF_ISEL(VCVTDQ2PD_XMMdq_XMMq) = CVTDQ2PD<VV128W, V128>;)
IF_AVX(DEF_ISEL(VCVTDQ2PD_YMMqq_MEMdq) = CVTDQ2PD_AVX<VV128W, MV128>;)
IF_AVX(DEF_ISEL(VCVTDQ2PD_YMMqq_XMMdq) = CVTDQ2PD_AVX<VV128W, V128>;)
...
DEF_ISEL(CVTTPD2DQ_XMMdq_MEMpd) = CVTTPD2DQ<V128W, MV128>;
DEF_ISEL(CVTTPD2DQ_XMMdq_XMMpd) = CVTTPD2DQ<V128W, V128>;
IF_AVX(DEF_ISEL(VCVTTPD2DQ_XMMdq_MEMdq) = CVTTPD2DQ<VV128W, MV128>;)
IF_AVX(DEF_ISEL(VCVTTPD2DQ_XMMdq_XMMdq) = CVTTPD2DQ<VV128W, V128>;)
