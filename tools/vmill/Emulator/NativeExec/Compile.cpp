...
void CompileToSharedObject(llvm::Module *module, const std::string &dest_path) {
  ...
  llvm::TargetLibraryInfoImpl tli(target_triple);

//  llvm::TargetRegistry<llvm::X>
  ...
  // Remill-produced bitcode uses tail-calls extensively.
  llvm::TargetOptions target_options;
  target_options.GuaranteedTailCallOpt = true;
  auto feature_str = GetNativeFeatureString();
